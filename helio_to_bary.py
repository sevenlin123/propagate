...
if __name__ == '__main__':
        ...
        pan_helio = np.array([280.750738,0.848447,24.162,234.434,114.957,0,2451117.681])
        pan_bary = np.array([2.60469723e+02,8.36677243e-01,2.41781000e+01,2.34318656e+02,1.14996323e+02,3.84523495e-03,2.45111768e+06])
        bary = helio_to_bary([eris_helio, ruby_helio, bp_helio, pan_helio])
        helio = bary_to_helio([eris_bary, ruby_bary, bp_bary, pan_bary])
        print(bary)
        print(helio)
